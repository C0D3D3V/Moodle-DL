...
- `moodle-dl --config`
    ...
    - The guide allows you to
      ...
      - set whether submissions (files uploaded to assignments by yourself or a teacher), descriptions, links inside descriptions, databases, quizzes, lessons and forum discussions should be downloaded.
