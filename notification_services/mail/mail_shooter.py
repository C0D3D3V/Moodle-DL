...
class MailShooter:
    ...
    def __init__(self, sender: str, smtp_server_host: str,
                 smtp_server_port: int, username: str, password: str):
        self.sender = sender
    ...
    def send(self, target: str, subject: str, html_content_with_cids: str,
             inline_png_cids_filenames: {str: str}):
        msg = EmailMessage()
        msg['Subject'] = subject
        ...
        for png_cid in inline_png_cids_filenames:
            ...
            with open(full_path_to_png, 'rb') as png_file:
                ...
                msg.get_payload()[1].add_related(
                    file_contents, 'image', 'png', cid=png_cid)

        with smtplib.SMTP(self.smtp_server_host,
                          self.smtp_server_port) as smtp_connection:
